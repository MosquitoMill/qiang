    ...
    <vue-table :data-source="tableList" :search-config="searchConfig" @on-query="changeQuery">
        ...
        <template slot="tbody" slot-scope="props">
            <tr>
                ...
                <td style="vertical-align: middle;">{{props.item.category.name}}</td>
                <td style="vertical-align: middle;">{{props.item.texture.name}}</td>
                <td class="col-lg-3" style="vertical-align: middle;">

                    <Tooltip content="查看" placement="top">
                        <i-button type="text" v-on:click="detailModel(props.item.id)"
