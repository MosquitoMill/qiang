                ...
                <Row type="flex">
                    <i-col span="24">
                        <Form-item label="分类名称" prop="name">
                            <i-input type="text" v-model="model.name" placeholder="请输入分类名称"></i-input>
                        </Form-item>
                    </i-col>
                    <i-col span="24">
                        <Form-item label="分类饼图颜色" prop="color">
                            <i-input type="text" v-model="model.color" placeholder="请输入饼图颜色"></i-input>
                        </Form-item>
                    </i-col>
                </Row>
            </i-form>
    ...
    data: function () {
      return {
        ...
        ruleValidate: {
          ...
          color: [
            {required: true, message: '分类饼图颜色不能为空', trigger: 'blur'}
          ]
        }
      }
    },
