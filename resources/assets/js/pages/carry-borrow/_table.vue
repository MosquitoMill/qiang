    ...
    <vue-table :data-source="tableList" :search-config="searchConfig" @on-query="changeQuery">
        ...
        <template slot="tbody" slot-scope="props">
            <tr>
                ...
                <td style="vertical-align: middle;">{{props.item.company}}</td>
                <td style="vertical-align: middle;">{{props.item.borrow_time}}</td>
                <td style="vertical-align: middle;">{{props.item.return_time}}</td>
