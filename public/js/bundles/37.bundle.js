...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dialog_vue__ = __webpack_require__(226);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__table_vue__ = __webpack_require__(229);
...
Component.options.__file = "resources\\assets\\js\\pages\\collection-work\\_dialog.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4073cd74", Component.options)
  } else {
    hotAPI.reload("data-v-4073cd74", Component.options)
' + '  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      isLoading: false,
      ruleValidate: {
        display_area: [{ required: true, message: '展区不能为空！', trigger: 'blur' }],
                ...
                [
                  _c(
                    ...
                    [
                      _c(
                        "Form-item",
                        { attrs: { label: "展览区域", prop: "display_area" } },
                        [
                          _c("i-input", {
                            attrs: { type: "text", placeholder: "请输入展区" },
                            model: {
                              value: _vm.model.display_area,
                              callback: function($$v) {
                                _vm.$set(_vm.model, "display_area", $$v)
                              },
                              expression: "model.display_area"
                            }
                          })
                        ],
                        1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4073cd74", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\pages\\collection-work\\_table.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a7de7580", Component.options)
  } else {
    hotAPI.reload("data-v-a7de7580", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
          ...
          fn: function(props) {
            return [
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", { staticStyle: { "vertical-align": "middle" } }, [
                  _vm._v(_vm._s(props.item.collection.address))
                ]),
                _vm._v(" "),
                _c("td", { staticStyle: { "vertical-align": "middle" } }, [
                  _vm._v(_vm._s(props.item.display_area))
                ]),
                _vm._v(" "),
                _c("td", { staticStyle: { "vertical-align": "middle" } }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a7de7580", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0cd02840", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\pages\\collection-work\\collectionWork.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0cd02840", Component.options)
  } else {
    hotAPI.reload("data-v-0cd02840", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
